...
data "popsrox_resource_name" "ovpn_server_vm" {
...
data "popsrox_resource_name" "ovpn-server-vm-nic-untrusted" {
...
data "popsrox_resource_name" "ovpn-server-vm-nic-trusted" {
...
data "popsrox_resource_name" "ovpn-server-vm-pip" {
